...
ActiveRecord::Schema.define(version: 20170826051428) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.string   "book_picture_file_name"
    t.string   "book_picture_content_type"
    t.integer  "book_picture_file_size"
    t.datetime "book_picture_updated_at"
